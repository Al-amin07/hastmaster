...
export default function Navbar() {
    ...
    return (
        <nav
            className={`z-50 top-0  left-0 w-full transition-all duration-300 ${scrolled ? 'fixed bg-white shadow dark:bg-gray-800' : 'absolute bg-transparent/75'
                }`}
        >
                    ...
                    <div className="flex flex-col md:flex-row md:mx-6">
                        {navLinks.map((link) => (
                            <Link
                                key={link.href}
                                href={link.href}
                                className="my-2 text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0"
                            >
                                {link.label}
                            </Link>
