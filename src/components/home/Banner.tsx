...
export default function Banner() {
    ...
    >
        <div className="flex items-center min-h-[600px] justify-center w-full bg-gray-900/20">
            <div className="px-24">
                <h1 className="text-3xl font-semibold  text-white w-[45%]  text-left lg:text-6xl">GLOBAL LEADERS
<br /> IN <br /> PRIVATE LABEL
HEADWEAR SOURCING.</h1>
